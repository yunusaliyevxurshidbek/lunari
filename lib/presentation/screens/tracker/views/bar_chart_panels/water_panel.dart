...
class WaterPanel extends StatefulWidget {
  const WaterPanel({super.key});

  @override
  State<WaterPanel> createState() => _WaterPanelState();
}

class _WaterPanelState extends State<WaterPanel> {
  int tabIndex = 0;
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: TabBar(
                      ...
                      unselectedLabelColor: const Color(0xFF1A96F0),
